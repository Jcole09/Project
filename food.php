...
<html>
    ...
    <body>
        ...
        <section class="home" id="home">
            <div class="home-text">
                <h1>Tastless</h1>
                <h2>It's not just a food <br> it's a state of taste buds</h2>
                <a href="foodmenu.php" class="btn">Today's Menu</a>
            </div>
        ...
        <section class="about" id="about">
            <div class="about-img">
                <img src="img/food/about.png">
            </div>

            <div class="about-text">
                <span>About Us</span>
                <h2>We speak the good <br> food language</h2>
                <p>Manyaman ku Manyaman ku Manyaman ku Manyaman ku Manyaman ku Manyaman kuManyaman ku Manyaman ku </p>
